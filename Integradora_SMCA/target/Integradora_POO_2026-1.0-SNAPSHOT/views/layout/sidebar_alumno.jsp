...
<aside class="figma-sidebar">
    ...
    <div class="sidebar-content">
        ...
        <div class="sidebar-profile-section">
                ...
                <div class="sidebar-avatar-img">
                    <c:choose>
                        <c:when test="${not empty sessionScope.usuarioLogueado.fotoPerfil}">
                            <img src="${pageContext.request.contextPath}/${sessionScope.usuarioLogueado.fotoPerfil}"
                                 alt="Foto de perfil">
                        </c:when>
                        <c:when test="${not empty sessionScope.alumno.fotoPerfil}">
                            <img src="${pageContext.request.contextPath}/${sessionScope.alumno.fotoPerfil}"
                                 alt="Foto de perfil">
                        </c:when>
                        <c:otherwise>
            ...
            <!-- Nombre Real del Usuario / Alumno -->
            <p class="sidebar-user-name">
                <c:choose>
                    <c:when test="${not empty sessionScope.alumno}">
