                    ...
                    <form id="formConfigCuenta" action="${pageContext.request.contextPath}/EditarPerfilServlet" method="POST" enctype="multipart/form-data">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-5 avatar-upload-section text-center">
                                ...
                                <label for="fotoInput" class="btn-upload-link" style="cursor: pointer;">Subir nueva foto</label>
                                <input type="file" id="fotoInput" name="fotoPerfil" accept="image/png, image/jpeg" class="d-none" onchange="previewImage(event)">

                                <p class="avatar-specs-text mt-2">
                            ...
                            <div class="col-md-7 profile-form-section">
                                ...
                                <!-- Botones de Acción Estilo UTEZ -->
                                <div class="actions-container mt-4 d-flex justify-content-end gap-3">
                                    <a href="javascript:history.back()" class="btn-action btn-cancel">Cancelar</a>
                                    <button type="submit" class="btn-action btn-registrar">Guardar cambios</button>
                                </div>
                            </div>
