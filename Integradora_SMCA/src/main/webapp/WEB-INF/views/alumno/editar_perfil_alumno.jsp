...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/editar_perfil_alumno.css">
</head>
<body>
...
<div class="main-content">
    ...
    <div class="content-body">
        ...
        <div class="text-center mb-4">
            <img src="${pageContext.request.contextPath}/assets/img/utez_logo.png" alt="Logo UTEZ" class="utez-logo-edit">
        ...
        <div class="edit-card">
            <form action="${pageContext.request.contextPath}/actualizar_perfil_servlet" method="POST" enctype="multipart/form-data" class="w-100 d-flex flex-wrap">
                ...
                <div class="edit-card-left">
                    ...
                    <input type="file" id="fotoInput" name="fotoPerfil" accept="image/png, image/jpeg" style="display: none;">
