...
/**
 * Muestra la alerta emergente de bienvenida UTEZ con reloj en tiempo real.
 * @param {string} nombreUsuario - Nombre del usuario logueado.
 * @param {string} contextPath - Ruta base de la aplicación (pageContext.request.contextPath).
 */
